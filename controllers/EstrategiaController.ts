...
export const elegirEstrategia = async (req:Request,res:Response)=>{
    const {id} = req.params
    ...
    try {
        ...
        return res.json("Estrategia aceptada")
